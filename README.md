...
npm install
Crea un archivo .env en la carpeta config dentro de la raíz del proyecto y configura las variables de entorno necesarias según el archivo .env.example.
...
npm install
Create a .env file in the config folder at the root of the project and configure the necessary environment variables according to the .env.example file.
